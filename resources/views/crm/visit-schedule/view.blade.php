                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group row">
                                <div class="col-6">
                                    ...
                                    <select class="form-control @error('visit_by') is-invalid @enderror" name="visit_by" required disabled>
                                ...
                                <div class="col-6">
                                    ...
                                    <input type="text" class="form-control @error('devision') is-invalid @enderror" name="devision" value="{{ $visit->devision }}" disabled>
                                    @error('devision')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group">
                                <label>Date *</label>
                                <input type="date" class="form-control @error('date') is-invalid @enderror" name="date" value="{{ $visit->date }}" require disabled>
                                @error('date')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                            <div class="form-group">
                                <label>Time</label>
                                <input type="time" class="form-control @error('time') is-invalid @enderror" name="time" value="{{ $visit->time }}" disabled>
                                @error('time')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group row">
                                ...
                                <div class="col-12">
                                    <textarea class="form-control" name="schedule" rows="6" disabled>{{ $visit->schedule }}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            <div class="form-group row">
                                ...
                                <div class="col-md-12">
                                    <select class="form-control" name="engineer[]" id="engineer" multiple="multiple" disabled>
                        ...
                        <div class="col-md-12 text-center">
                            <a href="{{ route('crm.visit-schedule.show') }}" class="btn btn-hero btn-danger text-white mr-3"><i class="fa fa-arrow-circle-left mr-2"></i>BACK</a>
    ...
    <x-slot name="js">
        <script>
            $(document).ready(function() {
                ...
                $('input[name=company]').val("{{ $visit->customer->company }}")
