                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control @error('due_date') is-invalid @enderror" name="due_date" value="{{ $inquiry->due_date }}" required>
                                    @error('due_date')
                                ...
                                <div class="form-group">
                                    <label>Subject *</label>
                                    <input type="text" class="form-control @error('subject') is-invalid @enderror" name="subject" value="{{ $inquiry->subject }}" required>
                                    @error('subject')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-12">
                                    <input type="text" class="js-rangeslider" id="example-rangeslider1" name="grade" value="{{ $inquiry->grade }}" required>
                                    </div>
                                    @error('grade')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
        ...
        <script>
            ...
            function listVisit()
            {
                ...
                $.get(url, function(response) {
                    ...
                    element += `<option value="{{ $inquiry->visit->uuid }}" selected>{{ $inquiry->visit->id }}</option>`
                    ...
                    $.each(data, function(index, value) {
                        element += `<li class="list-group-item">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <a href="/file/show/inquiry/{{ $inquiry->visit->uuid }}/${value.filename}" target="_blank">`+number+`. `+value.aliases+`</a>
