                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-md-12">
                                    <input type="text" class="form-control" name="" value="{{ strtoupper($visit->visit->id) }}" disabled>
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="" value="{{ strtoupper($visit->visit->customer->name . " - " . $visit->visit->customer->company) }}" disabled>
                            </div>
                            <div class="form-group row">
                                <div class="col-6">
                                    <label>Phone</label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-12">
                                    <textarea class="form-control @error('note') is-invalid @enderror" name="note" rows="6" disabled>{{ $visit->note }}</textarea>
                                    @error('note')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-12">
                                    <textarea class="form-control @error('planing') is-invalid @enderror" name="planing" rows="6" disabled>{{ $visit->planing }}</textarea>
                                    @error('planing')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
