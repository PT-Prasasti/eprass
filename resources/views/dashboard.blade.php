<x-app-layout>
    ...
    <div class="content row">
        ...
        <div class="col-xl-6">
            <div class="block block-themed block-mode-loading-inverse block-transparent bg-image w-100" style="background-image: url('assets/bg.png'); background-size: 200%; background-repeat:no-repeat; background-position:center;">
                <div class="block-header bg-white-op">
                    <div class="d-flex align-items-center">
                        <button type="button" onclick="pipelineChange('month')" id="pipeline-month" class="btn btn-link" disabled>
                            <i class="si si-arrow-left"></i>
                        </button>
                        <h3 class="block-title" id="pipeline-title">Pipeline {{ Carbon\Carbon::now()->format('M Y') }}</h3>
                        <button type="button" onclick="pipelineChange('year')" id="pipeline-year" class="btn btn-link">
                            <i class="si si-arrow-right"></i>
                        </button>
                    </div>
                    <div class="d-flex align-items-center">
                        <div class="block-options">
                            <button type="button" class="btn-block-option" onclick="pipelineReload()" data-toggle="block-option" data-action="state_toggle" data-action-mode="demo">
    ...
    <div class="content row">
        <div class="col-xl-12">
            <div class="block block-themed block-mode-loading-inverse block-transparent bg-image w-100" style="background-image: url('assets/bg.png'); background-size: 100%; background-repeat:no-repeat; background-position:center;">
                <div class="block-header bg-white-op">
                    <div class="d-flex align-items-center">
                        <button type="button" onclick="crmChange('month')" id="crm-month" class="btn btn-link" disabled>
                            <i class="si si-arrow-left"></i>
                        </button>
                        <h3 class="block-title" id="crm-title">Pipeline {{ Carbon\Carbon::now()->format('M Y') }}</h3>
                        <button type="button" onclick="crmChange('year')" id="crm-year" class="btn btn-link">
                            <i class="si si-arrow-right"></i>
                        </button>
                    </div>
                    <div class="block-options">
                        <button type="button" class="btn-block-option" onclick="crmReload()" data-toggle="block-option" data-action="state_toggle" data-action-mode="demo">
                            <i class="si si-refresh"></i>
                        </button>
                    </div>
                </div>
        ...
        <div class="col-xl-6">
            <div class="block block-themed block-mode-loading-inverse block-transparent bg-image w-100" style="background-image: url('assets/bgp3.png'); background-size: 200%; background-repeat:no-repeat; background-position:center;">
                <div class="block-header bg-white-op">
                    <div class="d-flex align-items-center">
                        <button type="button" onclick="visitChange('month')" id="visit-month" class="btn btn-link" disabled>
                            <i class="si si-arrow-left"></i>
                        </button>
                        <h3 class="block-title" id="visit-title">Visit Activity {{ Carbon\Carbon::now()->format('M Y') }}</h3>
                        <button type="button" onclick="visitChange('year')" id="visit-year" class="btn btn-link">
                            <i class="si si-arrow-right"></i>
                        </button>
                    </div>
                    <div class="d-flex align-items-center">
            ...
            channel.bind('my-event', async function(event) {
                try {
                    ...
                    if (newPipeline !== currentPipeline) {
                        ...
                        const response = await fetch("{{ route('dashboard.data-admin-sales') }}?pipeline=" + currentVisit);
        ...
        <script>
            ...
            function visitChange(value)
            {
                if(value == 'month') {
                    ...
                    document.getElementById('visit-title').innerHTML = "Visit Activity {{ Carbon\Carbon::now()->format('M Y') }}"
                } else {
