<x-app-layout>
    ...
    <x-slot name="js">
        <script>
            ...
            $(`[name="purchase_order_supplier"]`).select2({
                placeholder: "Select from the list",
                width: '100%',
                ajax: {
                    url: `{{ route('payment-request.search.purchase-order-supplier') }}`,
                    dataType: 'json',
                    language: "id",
                    type: 'GET',
                    delay: 450,
            ...
            $(document).on('select2:selecting', `[name="purchase_order_supplier"]`, function(e) {
                const data = e.params.args.data.data;
                handleSetPurchaseOrderSupplier(data);
            });
