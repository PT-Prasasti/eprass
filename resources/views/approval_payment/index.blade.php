                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row, meta) {
                            ...
                            html += `
                            <a type="button" href="" class="btn btn-sm btn-success js-tooltip-enabled" data-toggle="tooltip" title="Print">
                            ...
                            `;
                            html += `
                            <button type="button" class="btn btn-sm btn-danger js-tooltip-enabled" data-toggle="tooltip" title="Delete Visit">
