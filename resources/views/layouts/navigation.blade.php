        ...
        <div class="content-side content-side-full">
            <ul class="nav-main">
                ...
                @if (auth()->user()->hasRole('sales') ||
                    ...
                    <li>
                        <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="fa fa-edit"></i><span
                                class="sidebar-mini-hide">Inquiry</span></a>
                        <ul>
                            <li>
                ...
                @if (auth()->user()->hasRole('admin_sales') ||
                    ...
                    <li>
                        <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="fa fa-edit"></i><span
                                class="sidebar-mini-hide">Sales Order</span></a>
                        <ul>
                            <li>
