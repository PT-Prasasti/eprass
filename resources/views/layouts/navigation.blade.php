    ...
    <div class="sidebar-content">
        ...
        <div class="content-side content-side-full">
            <ul class="nav-main">
                ...
                <li>
                    <a class="{{ Request::is('logistic/good-received*') ? 'active' : '' }}" href="{{ route('logistic.good_received.index') }}"><i class="fa fa-file"></i><span class="sidebar-mini-hide">Good
                            Received</span></a>
                </li>

                <li>
                    <a class="{{ Request::is('logistic/delivery-order*') ? 'active' : '' }}" href="{{ route('logistic.delivery_order.index') }}"><i class="fa fa-calendar-check-o"></i><span class="sidebar-mini-hide">Delivery
                            Schedule</span></a>
                </li>
                <li>
                ...
                <li>
                    <a href="{{ route('transaction.sourcing-item') }}"><i class="fa fa-fax"></i><span class="sidebar-mini-hide" id="sourcing-item-nav">List App Item</span></a>
                </li>
                ...
                <li>
                    <a href="{{ route('purchase-order-customer') }}">
                        ...
                        <span class="sidebar-mini-hide" id="poc-nav">List PO Customer</span>
                    </a>
                </li>
                ...
                <li>
                    <a class="" href="{{ route('approval-po') }}"><i class="fa fa-calendar-check-o"></i><span class="sidebar-mini-hide" id="po-supplier-nav">App PO Supplier</span></a>
                </li>
                ...
                <li>
                    <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="fa fa-edit"></i><span class="sidebar-mini-hide" id="sales-order-nav">Sales
                            Order</span></a>
                    <ul>
                        <li>
                ...
                <li>
                    ...
                    @else
                    <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="fa fa-fax"></i><span class="sidebar-mini-hide" id="price-list-ready-sourcing-item-nav">Sourcing Item</span></a>
                    <ul>
                        <li>
                            <a href="{{ route('transaction.sourcing-item.add') }}">Add Sourcing Item</a>
                        </li>
                        <li>
                            <a href="{{ route('transaction.sourcing-item') }}">List Sourcing Item <span id="selection-done-list-sourcing-item-nav"></span></a>
                        </li>
                    </ul>
                <li>
                    <a class="nav-submenu" data-toggle="nav-submenu" href="#">
                ...
                <li>
                    <a class="" href="{{ route('approval-po') }}"><i class="fa fa-calendar-check-o"></i><span class="sidebar-mini-hide">App PO
                            Supplier</span></a>
                </li>
                <li>
                    <a class="active" href="{{ route('approval-payment') }}"><i class="fa fa-calendar-check-o"></i><span class="sidebar-mini-hide">App Payment
                            Request</span></a>
                </li>
                @else
                <li class="nav-main-heading">
                ...
                <li>
                    <a href="{{ route('purchase-order-supplier') }}">
                        <i class="fa fa-dollar"></i><span class="sidebar-mini-hide" id="po-supplier-nav">List PO Supplier</span></a>
                </li>
                ...
                <li>
                    <a class="{{ request()->is('payment-request*') ? 'active' : '' }}" href="{{ route('payment-request.exim') }}"><i class="fa fa-calendar-check-o"></i><span class="sidebar-mini-hide" id="payment-req-nav">App Payment Request</span></a>
                </li>
                @endif
                ...
                <li>
                    <a class="active" href="{{ route('payment-request.exim') }}"><i class="fa fa-file"></i><span class="sidebar-mini-hide">List Payment</span></a>
                </li>
                @endif
