<x-app-layout>
    ...
    <div class="content">
        <form method="POST" action="{{ route('transaction.sales-order.store') }}" enctype="multipart/form-data">
            @csrf
            <input type="hidden" name="id">
            <div class="row">
                <div class="col-md-6">
                    <h4><b>SO NUMBER : <span id="id"></span></b></h4>
                </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <label class="col-lg-1 col-form-label text-right">:</label>
                                        <div class="col-lg-8">
                                            <input type="text" class="form-control" name="sales" value=""
                                                disabled>
                                        </div>
                                    </div>
                                    <div class="form-group row">
    ...
    <x-slot name="js">
        <script>
            ...
            function generateId() {
                var url = "{{ route('transaction.sales-order.id') }}"
