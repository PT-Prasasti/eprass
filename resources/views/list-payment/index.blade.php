                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row, meta) {
                            ...
                            html += `
                            <a type="button" href="{{ route('list-payment') }}/${row.id}/edit" class="btn btn-sm btn-success js-tooltip-enabled" data-toggle="tooltip">
                            ...
                            switch (row.status) {
                                case 'Approved By Manager':
                                    html += `
                                    <a type="button" href="{{ route('list-payment') }}/${row.id}/bukti_transfer" class="btn btn-sm btn-primary js-tooltip-enabled" data-toggle="tooltip">
                                ...
                                default:
                                html += `
                                    <a type="button" href="#" class="btn btn-sm btn-dark js-tooltip-enabled" data-toggle="tooltip">
                                            <i class="fa fa-file-text-o"></i>
                                        </a>
                                    `;
                            }
