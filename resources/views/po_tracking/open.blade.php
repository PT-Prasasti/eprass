<x-app-layout>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-8">
                                                    <input type="text" class="form-control" value="{{ $tracking->purchase_order_supplier->sales_order->id }}" readonly>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <label class="col-lg-1 col-form-label text-right">:</label>
                                                <div class="col-lg-8">
                                                    <input type="text" class="form-control" value="{{ $tracking->purchase_order_supplier->sales_order->inquiry->visit->customer->name }}" readonly>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <label class="col-lg-1 col-form-label text-right">:</label>
                                                <div class="col-lg-8">
                                                    <input type="text" class="form-control" value="{{ \Carbon\Carbon::parse($tracking->purchase_order_supplier->sales_order->inquiry->due_date)->format('d F Y') }}" readonly>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <label class="col-lg-1 col-form-label text-right">:</label>
                                                <div class="col-lg-8">
                                                    <input type="text" class="form-control" value="{{ $tracking->purchase_order_supplier->sales_order->inquiry->subject }}" readonly>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group row">
                                                ...
                                                <label class="col-lg-1 col-form-label text-right">:</label>
                                                <div class="col-lg-8">
                                                    <input type="text" class="form-control" value="{{ $tracking->purchase_order_supplier->sales_order->sourcing->selected_sourcing_suppliers[0]->supplier->company }}" readonly>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <label class="col-lg-1 col-form-label text-right">:</label>
                                                <div class="col-lg-8">
                                                    <input type="text" class="form-control" value="{{ $tracking->purchase_order_supplier->sales_order->sourcing->selected_sourcing_suppliers[0]->supplier->company_phone }}" readonly>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <label class="col-lg-1 col-form-label text-right">:</label>
                                                <div class="col-lg-8">
                                                    <input type="text" class="form-control" value="{{ $tracking->purchase_order_supplier->sales_order->sourcing->selected_sourcing_suppliers[0]->supplier->sales_representation }}" readonly>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <label class="col-lg-1 col-form-label text-right">:</label>
                                                <div class="col-lg-4">
                                                    <input type="text" class="form-control" value="{{ $tracking->purchase_order_supplier->sales_order->sourcing->selected_sourcing_suppliers[0]->supplier->sales_email }}" readonly>
                                                </div>
                                                <div class="col-lg-4">
                                                    <input type="text" class="form-control" value="{{ $tracking->purchase_order_supplier->sales_order->sourcing->selected_sourcing_suppliers[0]->supplier->sales_number }}" readonly>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    <x-slot name="js">
        ...
        <script>
            var FORWARDER_OPT = {!!json_encode($data['forwarders']) !!};
            var FORWARDER_PRODUCT = {!!json_encode($data['forwarders_item']) !!};
            console.log(FORWARDER_PRODUCT);
            var IS_READONLY = true;

            function review_forwarder_select(datas) {
                    ...
                    <div class="item-information">
                        <div class="row m-0">
                            <div class="col-2">
                                <small>No.</small>
                                <p>` + no + `</p>
                                <input type="hidden" class="product_inquery_id" name="product_inquery_id[]" value="` + value
                        ...
                        .sourcing_supplier.id + `">
                            ...
                            <div class="col-8">
                                ...
                                <p class="m-0">Total Price : ` + value.sourcing_supplier.qty * datas[index]
