<x-app-layout>
    ...
    <div class="content">
        ...
        <div class="row">
            <div class="col-md-6">
                <h4><b>List Supplier</b></h4>
            </div>
            <div class="col-md-6 text-right">
                <a type="button" href="{{ route('data-master.supplier.add') }}" class="btn btn-info min-width-125"><i class="fa fa-plus mr-2"></i>NEW SUPPLIER</a>
            </div>
        </div>
    ...
    <script>
        ...
        function dataTable()
        {
            ...
            $('#dataTable').DataTable({
                ...
                ajax: {
                    "url": "{{ route('data-master.supplier.data') }}",
                    "type": "POST",
                    "data": {
                        "_token": "{{ csrf_token() }}"
                    }
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        render: function(data) {
                            return `<a type="button" href="supplier/edit/${data}" class="btn btn-sm btn-info" data-toggle="tooltip" title="View Customer">
