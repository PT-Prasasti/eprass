<x-app-layout>
    ...
    <div class="content">
        ...
        <div class="row">
            <div class="col-md-6">
                <h4><b>List Customer</b></h4>
            </div>
            <div class="col-md-6 text-right">
                <a type="button" href="{{ route('data-master.customer.add') }}" class="btn btn-info min-width-125"><i class="fa fa-plus mr-2"></i>NEW CUSTOMER</a>
            </div>
        </div>
                ...
                <table class="table table-striped table-vcenter js-dataTable-simple" style="font-size:13px" id="dataTable">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center">Costomer - Company Name</th>
    ...
    <script>
        ...
        function dataTable()
        {
            ...
            $('#dataTable').DataTable({
                ...
                ajax: {
                    "url": "{{ route('data-master.customer.data') }}",
                    "type": "POST",
                    "data": {
                        "_token": "{{ csrf_token() }}"
                    }
