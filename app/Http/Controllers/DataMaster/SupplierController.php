...
class SupplierController extends Controller
{
    ...
    public function store(AddSupplierRequest $request): RedirectResponse
    {
        try {
            ...
            $supplier->uuid = Uuid::generate()->string;
            ...
            $supplier->item_specialization = $request->item_spesialization;
            $supplier->address = $request->address;
            $supplier->sales_representation = $request->sales_representative;
            $supplier->sales_number  = $request->contact_number;
            $supplier->sales_email = $request->sales_email;
            $supplier->location = $request->location == "1" ? "Indonesia" : "Luar Negeri";
